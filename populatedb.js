...
function magazineCreate(title, publisher, pages, pbdate) {
    magazinedetail = {
        title: title,
        publisher: publisher,
        pages: pages,
        publication_date: pbdate
    };

    var magazine = new Magazine(magazinedetail);
    magazine.save();
}
...
function createMagazines(){
    magazineCreate("title", "publisher", 10, 10/10/2020);
}
